...
public abstract class RoyalcanadapoliceofficerItem extends ArmorItem {
   public RoyalcanadapoliceofficerItem(Type type, Properties properties) {
   ...
   public static class Boots extends RoyalcanadapoliceofficerItem {
               ...
               public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
                  HumanoidModel armorModel = new HumanoidModel(
                     new ModelPart(
                        ...
                        Map.of(
                           "left_leg",
                           (new Modelroyalcan(Minecraft.getInstance().getEntityModels().bakeLayer(Modelroyalcan.LAYER_LOCATION))).LeftLeg,
                           "right_leg",
                           (new Modelroyalcan(Minecraft.getInstance().getEntityModels().bakeLayer(Modelroyalcan.LAYER_LOCATION))).RightLeg,
                           "head",
      ...
      public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
         return "apocalypsenow:textures/entities/royalcan.png";
      }
               ...
               public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
                  HumanoidModel armorModel = new HumanoidModel(
                     new ModelPart(
                        ...
                        Map.of(
                           "body",
                           (new Modelroyalcan(Minecraft.getInstance().getEntityModels().bakeLayer(Modelroyalcan.LAYER_LOCATION))).Body,
                           "left_arm",
                           (new Modelroyalcan(Minecraft.getInstance().getEntityModels().bakeLayer(Modelroyalcan.LAYER_LOCATION))).LeftArm,
                           "right_arm",
                           (new Modelroyalcan(Minecraft.getInstance().getEntityModels().bakeLayer(Modelroyalcan.LAYER_LOCATION))).RightArm,
                           "head",
                           new ModelPart(Collections.emptyList(), Collections.emptyMap()),
                           "hat",
                           new ModelPart(Collections.emptyList(), Collections.emptyMap()),
   ...
   public static class Helmet extends RoyalcanadapoliceofficerItem {
      ...
      @Override
      public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
         return "apocalypsenow:textures/entities/canadahats.png";
      }
   }
   ...
   public static class Leggings extends RoyalcanadapoliceofficerItem {
      ...
      @Override
      public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
         return "apocalypsenow:textures/entities/canadapants.png";
      }
   }
}

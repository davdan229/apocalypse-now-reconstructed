...
public abstract class BaseballcapblueItem extends ArmorItem {
   public BaseballcapblueItem(Type type, Properties properties) {
   ...
   public static class Helmet extends BaseballcapblueItem {
      public Helmet() {
      ...
      public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
         return "apocalypsenow:textures/entities/baseballcapblue.png";
      }
   }
}

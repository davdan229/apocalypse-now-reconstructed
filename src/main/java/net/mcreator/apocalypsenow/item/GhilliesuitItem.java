...
public abstract class GhilliesuitItem extends ArmorItem {
   public GhilliesuitItem(Type type, Properties properties) {
   ...
   public static class Boots extends GhilliesuitItem {
      ...
      public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
         return "apocalypsenow:textures/models/armor/ghillie_suit__layer_1.png";
      }
   ...
   public static class Leggings extends GhilliesuitItem {
      ...
      @Override
      public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
         return "apocalypsenow:textures/models/armor/ghillie_suit__layer_2.png";
      }
   }
}

...
import net.mcreator.apocalypsenow.procedures.TaserLivingEntityIsHitWithToolProcedure;
...
public class TaserItem extends SwordItem {
   public TaserItem() {
      super(
         new Tier() {
            @Override
            ...
            public Ingredient getRepairIngredient() {
               return Ingredient.of(
                  new ItemStack(ApocalypsenowModItems.AABATTERY.get()),
   ...
   public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
      ...
      TaserLivingEntityIsHitWithToolProcedure.execute(entity);
      return retval;
   }

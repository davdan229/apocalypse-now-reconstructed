...
public class EletricalbaseballbatItem extends SwordItem {
   public EletricalbaseballbatItem() {
      super(
         new Tier() {
            @Override
            public int getUses() {
            ...
            public Ingredient getRepairIngredient() {
               return Ingredient.of(
                  new ItemStack(ApocalypsenowModItems.GLUE.get()), new ItemStack(ApocalypsenowModItems.DUCTTAPE.get()), new ItemStack(Blocks.OAK_PLANKS)
               );
            }
         },
         3,

...
public abstract class BaseallcapgreenItem extends ArmorItem {
   public BaseallcapgreenItem(Type type, Properties properties) {
   ...
   public static class Helmet extends BaseallcapgreenItem {
      public Helmet() {
      ...
      public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
         return "apocalypsenow:textures/entities/baseballcapgreen.png";
      }
   }
}

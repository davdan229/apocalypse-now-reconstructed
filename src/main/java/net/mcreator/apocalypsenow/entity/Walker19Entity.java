...
public class Walker19Entity extends Monster {
   public Walker19Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_19.get(), world);
   }

   public Walker19Entity(EntityType<Walker19Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_19.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_19.get(), 180);
   }

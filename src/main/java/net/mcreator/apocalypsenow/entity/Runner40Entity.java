...
public class Runner40Entity extends Monster {
   public Runner40Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_40.get(), world);
   }

   public Runner40Entity(EntityType<Runner40Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_40.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_40.get(), 180);
   }

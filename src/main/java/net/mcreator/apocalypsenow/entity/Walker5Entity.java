...
public class Walker5Entity extends Monster {
   public Walker5Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_5.get(), world);
   }

   public Walker5Entity(EntityType<Walker5Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_5.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_5.get(), 180);
   }

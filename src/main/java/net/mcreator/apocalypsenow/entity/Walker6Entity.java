...
public class Walker6Entity extends Monster {
   public Walker6Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_6.get(), world);
   }

   public Walker6Entity(EntityType<Walker6Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_6.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_6.get(), 180);
   }

...
public class Runner49Entity extends Monster {
   public Runner49Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_49.get(), world);
   }

   public Runner49Entity(EntityType<Runner49Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_49.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_49.get(), 180);
   }

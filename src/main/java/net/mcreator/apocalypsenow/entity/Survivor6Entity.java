...
public class Survivor6Entity extends HumanFactionMob {
   public Survivor6Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.SURVIVOR_6.get(), world);
   }

   public Survivor6Entity(EntityType<Survivor6Entity> type, Level world) {
      super(type, world);
      this.setMaxUpStep(0.6F);
      this.xpReward = 2;
      this.setNoAi(false);
      this.setPersistenceRequired();
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ApocalypsenowModItems.KITCHEN_KNIFE.get()));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.SURVIVOR_6.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

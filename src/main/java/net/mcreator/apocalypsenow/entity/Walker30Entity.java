...
public class Walker30Entity extends Monster {
   public Walker30Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_30.get(), world);
   }

   public Walker30Entity(EntityType<Walker30Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_30.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_30.get(), 180);
   }

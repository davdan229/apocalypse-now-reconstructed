...
public class Runner45Entity extends Monster {
   public Runner45Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_45.get(), world);
   }

   public Runner45Entity(EntityType<Runner45Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_45.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_45.get(), 180);
   }

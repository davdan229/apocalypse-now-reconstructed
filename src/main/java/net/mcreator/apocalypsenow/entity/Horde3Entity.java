...
import net.mcreator.apocalypsenow.procedures.Horde3oninitialspawnProcedure;
...
public class Horde3Entity extends Monster {
   public Horde3Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.HORDE_3.get(), world);
   }

   public Horde3Entity(EntityType<Horde3Entity> type, Level world) {
      super(type, world);
   ...
   public SpawnGroupData finalizeSpawn(
      ...
      Horde3oninitialspawnProcedure.execute(world, this.getX(), this.getY(), this.getZ());
      return retval;
   }

   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.HORDE_3.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

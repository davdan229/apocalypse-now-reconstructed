...
public class Walker22Entity extends Monster {
   public Walker22Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_22.get(), world);
   }

   public Walker22Entity(EntityType<Walker22Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_22.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_22.get(), 180);
   }

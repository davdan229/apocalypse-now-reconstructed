...
public class Looter2Entity extends Monster {
   public Looter2Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.LOOTER_2.get(), world);
   }

   public Looter2Entity(EntityType<Looter2Entity> type, Level world) {
      super(type, world);
      this.setMaxUpStep(0.6F);
      this.xpReward = 6;
      this.setNoAi(false);
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ApocalypsenowModItems.HAWKBILL_MACHETE.get()));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.LOOTER_2.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

...
public class Runner42Entity extends Monster {
   public Runner42Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_42.get(), world);
   }

   public Runner42Entity(EntityType<Runner42Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_42.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_42.get(), 180);
   }

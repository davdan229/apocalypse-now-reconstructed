...
public class Walker18Entity extends Monster {
   public Walker18Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_18.get(), world);
   }

   public Walker18Entity(EntityType<Walker18Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_18.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_18.get(), 180);
   }

...
public class Military02Entity extends HumanFactionMob {
   public Military02Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.MILITARY_02.get(), world);
   }

   public Military02Entity(EntityType<Military02Entity> type, Level world) {
      super(type, world);
      this.setMaxUpStep(0.6F);
      this.xpReward = 0;
      this.setNoAi(false);
      this.setPersistenceRequired();
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ApocalypsenowModItems.KUKRI_MACHETE.get()));
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.MILITARY_02.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

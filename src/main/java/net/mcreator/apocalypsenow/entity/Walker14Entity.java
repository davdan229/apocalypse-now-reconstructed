...
public class Walker14Entity extends Monster {
   public Walker14Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_14.get(), world);
   }

   public Walker14Entity(EntityType<Walker14Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_14.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_14.get(), 180);
   }

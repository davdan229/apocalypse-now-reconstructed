...
public class Runner39Entity extends Monster {
   public Runner39Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_39.get(), world);
   }

   public Runner39Entity(EntityType<Runner39Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_39.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_39.get(), 180);
   }

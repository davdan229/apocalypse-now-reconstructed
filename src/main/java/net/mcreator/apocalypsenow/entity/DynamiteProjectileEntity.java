...
public class DynamiteProjectileEntity extends AbstractArrow implements ItemSupplier {
   public static final ItemStack PROJECTILE_ITEM = new ItemStack(ApocalypsenowModItems.DYNAMITE.get());

   public DynamiteProjectileEntity(SpawnEntity packet, Level world) {
      super(ApocalypsenowModEntities.DYNAMITE_PROJECTILE.get(), world);
   }
   ...
   public static DynamiteProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      DynamiteProjectileEntity entityarrow = new DynamiteProjectileEntity(ApocalypsenowModEntities.DYNAMITE_PROJECTILE.get(), entity, world);
      ...
      world.playSound(
         ...
         entity.getY(),
         entity.getZ(),
         ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.tnt.primed")),
         SoundSource.PLAYERS,
         1.0F,
   ...
   public static DynamiteProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      DynamiteProjectileEntity entityarrow = new DynamiteProjectileEntity(ApocalypsenowModEntities.DYNAMITE_PROJECTILE.get(), entity, entity.level());

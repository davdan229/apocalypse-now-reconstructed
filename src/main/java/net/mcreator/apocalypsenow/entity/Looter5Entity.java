...
public class Looter5Entity extends Monster {
   public Looter5Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.LOOTER_5.get(), world);
   }

   public Looter5Entity(EntityType<Looter5Entity> type, Level world) {
      super(type, world);
      this.setMaxUpStep(0.6F);
      this.xpReward = 6;
      this.setNoAi(false);
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ApocalypsenowModItems.RED_CROWBAR.get()));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.LOOTER_5.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

...
public class Walker27Entity extends Monster {
   public Walker27Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_27.get(), world);
   }

   public Walker27Entity(EntityType<Walker27Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_27.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_27.get(), 180);
   }

...
public class Walker29Entity extends Monster {
   public Walker29Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_29.get(), world);
   }

   public Walker29Entity(EntityType<Walker29Entity> type, Level world) {
      super(type, world);
      this.setMaxUpStep(0.6F);
      this.xpReward = 6;
      this.setNoAi(false);
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(ApocalypsenowModItems.RED_FOOTBALL_ARMOR_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(ApocalypsenowModItems.RED_FOOTBALL_ARMOR_CHESTPLATE.get()));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_29.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_29.get(), 180);
   }

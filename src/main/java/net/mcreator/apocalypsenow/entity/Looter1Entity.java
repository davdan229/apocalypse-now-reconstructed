...
public class Looter1Entity extends Monster {
   public Looter1Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.LOOTER_1.get(), world);
   }

   public Looter1Entity(EntityType<Looter1Entity> type, Level world) {
      super(type, world);
      this.setMaxUpStep(0.6F);
      this.xpReward = 6;
      this.setNoAi(false);
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ApocalypsenowModItems.FIRE_AXE.get()));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.LOOTER_1.get(), Type.NO_RESTRICTIONS, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

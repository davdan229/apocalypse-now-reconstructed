...
public class Crawler4Entity extends Monster {
   public Crawler4Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.CRAWLER_4.get(), world);
   }

   public Crawler4Entity(EntityType<Crawler4Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.CRAWLER_4.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

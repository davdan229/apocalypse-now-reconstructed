...
public class Survivor2Entity extends HumanFactionMob {
   public Survivor2Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.SURVIVOR_2.get(), world);
   }

   public Survivor2Entity(EntityType<Survivor2Entity> type, Level world) {
      super(type, world);
      this.setMaxUpStep(0.6F);
      this.xpReward = 2;
      this.setNoAi(false);
      this.setPersistenceRequired();
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ApocalypsenowModItems.HAMMER_PICKAXE.get()));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.SURVIVOR_2.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

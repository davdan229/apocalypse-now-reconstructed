...
public class Looter3Entity extends Monster {
   public Looter3Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.LOOTER_3.get(), world);
   }

   public Looter3Entity(EntityType<Looter3Entity> type, Level world) {
      super(type, world);
      this.setMaxUpStep(0.6F);
      this.xpReward = 6;
      this.setNoAi(false);
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ApocalypsenowModItems.HAND_AXE.get()));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.LOOTER_3.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

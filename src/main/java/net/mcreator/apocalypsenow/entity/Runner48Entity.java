...
public class Runner48Entity extends Monster {
   public Runner48Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_48.get(), world);
   }

   public Runner48Entity(EntityType<Runner48Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_48.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_48.get(), 180);
   }

...
import net.mcreator.apocalypsenow.procedures.MilitarydropboxProcedure;
...
public class MilitarydropEntity extends Monster {
   public MilitarydropEntity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.MILITARYDROP.get(), world);
   }

   public MilitarydropEntity(EntityType<MilitarydropEntity> type, Level world) {
      super(type, world);
   ...
   public void baseTick() {
      super.baseTick();
      MilitarydropboxProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }

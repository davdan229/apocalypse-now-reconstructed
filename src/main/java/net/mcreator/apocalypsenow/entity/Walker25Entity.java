...
public class Walker25Entity extends Monster {
   public Walker25Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_25.get(), world);
   }

   public Walker25Entity(EntityType<Walker25Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_25.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_25.get(), 180);
   }

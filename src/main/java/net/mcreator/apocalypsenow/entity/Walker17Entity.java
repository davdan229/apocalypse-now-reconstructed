...
public class Walker17Entity extends Monster {
   public Walker17Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_17.get(), world);
   }

   public Walker17Entity(EntityType<Walker17Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_17.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_17.get(), 180);
   }

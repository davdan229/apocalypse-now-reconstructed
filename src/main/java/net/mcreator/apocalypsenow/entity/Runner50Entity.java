...
public class Runner50Entity extends Monster {
   public Runner50Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_50.get(), world);
   }

   public Runner50Entity(EntityType<Runner50Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_50.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_50.get(), 180);
   }

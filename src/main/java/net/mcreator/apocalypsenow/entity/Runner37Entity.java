...
public class Runner37Entity extends Monster {
   public Runner37Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_37.get(), world);
   }

   public Runner37Entity(EntityType<Runner37Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_37.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_37.get(), 180);
   }

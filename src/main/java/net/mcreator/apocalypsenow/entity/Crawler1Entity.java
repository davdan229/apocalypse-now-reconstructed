...
public class Crawler1Entity extends Monster {
   public Crawler1Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.CRAWLER_1.get(), world);
   }

   public Crawler1Entity(EntityType<Crawler1Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.CRAWLER_1.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

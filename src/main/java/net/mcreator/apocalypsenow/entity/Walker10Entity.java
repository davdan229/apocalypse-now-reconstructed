...
public class Walker10Entity extends Monster {
   public Walker10Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_10.get(), world);
   }

   public Walker10Entity(EntityType<Walker10Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_10.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_10.get(), 180);
   }

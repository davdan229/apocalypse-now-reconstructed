...
public class Runner54Entity extends Monster {
   public Runner54Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_54.get(), world);
   }

   public Runner54Entity(EntityType<Runner54Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_54.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_54.get(), 180);
   }

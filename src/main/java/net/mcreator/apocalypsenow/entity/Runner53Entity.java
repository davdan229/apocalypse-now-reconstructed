...
public class Runner53Entity extends Monster {
   public Runner53Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_53.get(), world);
   }

   public Runner53Entity(EntityType<Runner53Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_53.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_53.get(), 180);
   }

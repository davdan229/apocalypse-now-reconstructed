...
public class Crawler2Entity extends Monster {
   public Crawler2Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.CRAWLER_2.get(), world);
   }

   public Crawler2Entity(EntityType<Crawler2Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.CRAWLER_2.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

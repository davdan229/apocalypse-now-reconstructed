...
public class Walker3Entity extends Monster {
   public Walker3Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_3.get(), world);
   }

   public Walker3Entity(EntityType<Walker3Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_3.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_3.get(), 180);
   }

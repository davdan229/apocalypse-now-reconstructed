...
public class Survivor10Entity extends HumanFactionMob {
   public Survivor10Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.SURVIVOR_10.get(), world);
   }

   public Survivor10Entity(EntityType<Survivor10Entity> type, Level world) {
      super(type, world);
      this.setMaxUpStep(0.6F);
      this.xpReward = 2;
      this.setNoAi(false);
      this.setPersistenceRequired();
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ApocalypsenowModItems.TAIGA_1_SURVIVAL_MACHETE.get()));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.SURVIVOR_10.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

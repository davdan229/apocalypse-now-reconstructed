...
public class Walker26Entity extends Monster {
   public Walker26Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_26.get(), world);
   }

   public Walker26Entity(EntityType<Walker26Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_26.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_26.get(), 180);
   }

...
public class Walker7Entity extends Monster {
   public Walker7Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_7.get(), world);
   }

   public Walker7Entity(EntityType<Walker7Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_7.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_7.get(), 180);
   }

...
public class Runner36Entity extends Monster {
   public Runner36Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_36.get(), world);
   }

   public Runner36Entity(EntityType<Runner36Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_36.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_36.get(), 180);
   }

...
public class Walker13Entity extends Monster {
   public Walker13Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_13.get(), world);
   }

   public Walker13Entity(EntityType<Walker13Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_13.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_13.get(), 180);
   }

...
public class NailprojectileEntity extends AbstractArrow implements ItemSupplier {
   public static final ItemStack PROJECTILE_ITEM = new ItemStack(ApocalypsenowModItems.NAIL.get());

   public NailprojectileEntity(SpawnEntity packet, Level world) {
      super(ApocalypsenowModEntities.NAILPROJECTILE.get(), world);
   }
   ...
   public static NailprojectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
   ...
   public static NailprojectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      NailprojectileEntity entityarrow = new NailprojectileEntity(ApocalypsenowModEntities.NAILPROJECTILE.get(), entity, world);
      ...
      world.playSound(
         ...
         entity.getY(),
         entity.getZ(),
         ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("apocalypsenow:nailgun")),
         SoundSource.PLAYERS,
         1.0F,
   ...
   public static NailprojectileEntity shoot(LivingEntity entity, LivingEntity target) {
      NailprojectileEntity entityarrow = new NailprojectileEntity(ApocalypsenowModEntities.NAILPROJECTILE.get(), entity, entity.level());

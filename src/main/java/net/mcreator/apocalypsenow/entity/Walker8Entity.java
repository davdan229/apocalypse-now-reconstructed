...
public class Walker8Entity extends Monster {
   public Walker8Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_8.get(), world);
   }

   public Walker8Entity(EntityType<Walker8Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_8.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_8.get(), 180);
   }

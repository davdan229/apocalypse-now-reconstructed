...
public class Walker33Entity extends Monster {
   public Walker33Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_33.get(), world);
   }

   public Walker33Entity(EntityType<Walker33Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_33.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_33.get(), 180);
   }

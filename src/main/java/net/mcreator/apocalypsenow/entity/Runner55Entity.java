...
public class Runner55Entity extends Monster {
   public Runner55Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_55.get(), world);
   }

   public Runner55Entity(EntityType<Runner55Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_55.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_55.get(), 180);
   }

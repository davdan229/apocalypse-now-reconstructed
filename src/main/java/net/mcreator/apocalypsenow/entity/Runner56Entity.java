...
import net.mcreator.apocalypsenow.procedures.EasterbunnywalkerProcedure;
...
public class Runner56Entity extends Monster {
   public Runner56Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_56.get(), world);
   }

   public Runner56Entity(EntityType<Runner56Entity> type, Level world) {
      super(type, world);
   ...
   protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
      ...
      this.spawnAtLocation(new ItemStack(ApocalypsenowModItems.EASTEREGG.get()));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_56.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
            return EasterbunnywalkerProcedure.execute(world, x, y, z);
         }
      );
   }
   ...
   public static Builder createAttributes() {
      ...
      return builder.add(Attributes.FOLLOW_RANGE, 128.0);
   }
}

...
public class Walker21Entity extends Monster {
   public Walker21Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_21.get(), world);
   }

   public Walker21Entity(EntityType<Walker21Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_21.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_21.get(), 180);
   }

...
public class Crawler3Entity extends Monster {
   public Crawler3Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.CRAWLER_3.get(), world);
   }

   public Crawler3Entity(EntityType<Crawler3Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.CRAWLER_3.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

...
public class Runner46Entity extends Monster {
   public Runner46Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_46.get(), world);
   }

   public Runner46Entity(EntityType<Runner46Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_46.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_46.get(), 180);
   }

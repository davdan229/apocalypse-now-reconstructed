...
public class Runner51Entity extends Monster {
   public Runner51Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_51.get(), world);
   }

   public Runner51Entity(EntityType<Runner51Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_51.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_51.get(), 180);
   }

...
public class Runner35Entity extends Monster {
   public Runner35Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_35.get(), world);
   }

   public Runner35Entity(EntityType<Runner35Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_35.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_35.get(), 180);
   }

...
import net.mcreator.apocalypsenow.procedures.DropboxOnEntityTickUpdateProcedure;
...
public class DropboxEntity extends Monster {
   public DropboxEntity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.DROPBOX.get(), world);
   }

   public DropboxEntity(EntityType<DropboxEntity> type, Level world) {
      super(type, world);
   ...
   public void baseTick() {
      super.baseTick();
      DropboxOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }

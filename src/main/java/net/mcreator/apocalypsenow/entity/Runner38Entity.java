...
public class Runner38Entity extends Monster {
   public Runner38Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_38.get(), world);
   }

   public Runner38Entity(EntityType<Runner38Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_38.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_38.get(), 180);
   }

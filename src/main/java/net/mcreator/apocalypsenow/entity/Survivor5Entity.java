...
public class Survivor5Entity extends HumanFactionMob {
   public Survivor5Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.SURVIVOR_5.get(), world);
   }

   public Survivor5Entity(EntityType<Survivor5Entity> type, Level world) {
      super(type, world);
      this.setMaxUpStep(0.6F);
      this.xpReward = 2;
      this.setNoAi(false);
      this.setPersistenceRequired();
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ApocalypsenowModItems.SPIKED_BASEBALL_BAT.get()));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.SURVIVOR_5.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

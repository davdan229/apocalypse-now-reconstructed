...
public class Runner34Entity extends Monster {
   public Runner34Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_34.get(), world);
   }

   public Runner34Entity(EntityType<Runner34Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_34.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_34.get(), 180);
   }

...
public class Walker20Entity extends Monster {
   public Walker20Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_20.get(), world);
   }

   public Walker20Entity(EntityType<Walker20Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_20.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_20.get(), 180);
   }

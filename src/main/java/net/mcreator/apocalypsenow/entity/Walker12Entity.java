...
public class Walker12Entity extends Monster {
   public Walker12Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_12.get(), world);
   }

   public Walker12Entity(EntityType<Walker12Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_12.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_12.get(), 180);
   }

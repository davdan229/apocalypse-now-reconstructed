...
public class Runner43Entity extends Monster {
   public Runner43Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_43.get(), world);
   }

   public Runner43Entity(EntityType<Runner43Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_43.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_43.get(), 180);
   }

...
public class Runner52Entity extends Monster {
   public Runner52Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_52.get(), world);
   }

   public Runner52Entity(EntityType<Runner52Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_52.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_52.get(), 180);
   }

...
import net.mcreator.apocalypsenow.procedures.Horde2oninitialspawnProcedure;
...
public class Horde2Entity extends Monster {
   public Horde2Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.HORDE_2.get(), world);
   }

   public Horde2Entity(EntityType<Horde2Entity> type, Level world) {
      super(type, world);
   ...
   public SpawnGroupData finalizeSpawn(
      ...
      Horde2oninitialspawnProcedure.execute(world, this.getX(), this.getY(), this.getZ());
      return retval;
   }

   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.HORDE_2.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

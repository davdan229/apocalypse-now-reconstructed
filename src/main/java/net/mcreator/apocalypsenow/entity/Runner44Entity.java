...
public class Runner44Entity extends Monster {
   public Runner44Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_44.get(), world);
   }

   public Runner44Entity(EntityType<Runner44Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_44.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_44.get(), 180);
   }

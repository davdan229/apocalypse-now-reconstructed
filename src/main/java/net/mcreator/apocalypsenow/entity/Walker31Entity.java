...
public class Walker31Entity extends Monster {
   public Walker31Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_31.get(), world);
   }

   public Walker31Entity(EntityType<Walker31Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_31.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_31.get(), 180);
   }

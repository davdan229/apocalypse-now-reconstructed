...
public class Walker11Entity extends Monster {
   public Walker11Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_11.get(), world);
   }

   public Walker11Entity(EntityType<Walker11Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_11.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_11.get(), 180);
   }

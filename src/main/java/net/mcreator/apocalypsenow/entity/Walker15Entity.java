...
public class Walker15Entity extends Monster {
   public Walker15Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_15.get(), world);
   }

   public Walker15Entity(EntityType<Walker15Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_15.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_15.get(), 180);
   }

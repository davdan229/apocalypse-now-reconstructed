...
public class SoldiersEntity extends HumanFactionMob {
   public SoldiersEntity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.SOLDIERS.get(), world);
   }
   ...
   public SoldiersEntity(EntityType<SoldiersEntity> type, Level world) {
      ...
      this.xpReward = 6;
      this.setNoAi(false);
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ApocalypsenowModItems.TASER.get()));
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(ApocalypsenowModItems.SPEC_OPS_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(ApocalypsenowModItems.SPEC_OPS_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(ApocalypsenowModItems.SPEC_OPS_LEGGINGS.get()));
      this.setItemSlot(EquipmentSlot.FEET, new ItemStack(ApocalypsenowModItems.SPEC_OPS_BOOTS.get()));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.SOLDIERS.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

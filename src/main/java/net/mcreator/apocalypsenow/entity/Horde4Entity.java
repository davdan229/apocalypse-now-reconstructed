...
import net.mcreator.apocalypsenow.procedures.Horde4oninitialspawnProcedure;
...
public class Horde4Entity extends Monster {
   public Horde4Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.HORDE_4.get(), world);
   }

   public Horde4Entity(EntityType<Horde4Entity> type, Level world) {
      super(type, world);
   ...
   public SpawnGroupData finalizeSpawn(
      ...
      Horde4oninitialspawnProcedure.execute(world, this.getX(), this.getY(), this.getZ());
      return retval;
   }

   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.HORDE_4.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

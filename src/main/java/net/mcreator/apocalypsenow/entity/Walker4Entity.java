...
public class Walker4Entity extends Monster {
   public Walker4Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_4.get(), world);
   }

   public Walker4Entity(EntityType<Walker4Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_4.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_4.get(), 180);
   }

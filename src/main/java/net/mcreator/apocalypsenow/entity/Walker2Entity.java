...
public class Walker2Entity extends Monster {
   public Walker2Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_2.get(), world);
   }

   public Walker2Entity(EntityType<Walker2Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_2.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_2.get(), 180);
   }

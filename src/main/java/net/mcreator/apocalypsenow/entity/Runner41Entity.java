...
public class Runner41Entity extends Monster {
   public Runner41Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.RUNNER_41.get(), world);
   }

   public Runner41Entity(EntityType<Runner41Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.RUNNER_41.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.RUNNER_41.get(), 180);
   }

...
public class Walker24Entity extends Monster {
   public Walker24Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_24.get(), world);
   }

   public Walker24Entity(EntityType<Walker24Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_24.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_24.get(), 180);
   }

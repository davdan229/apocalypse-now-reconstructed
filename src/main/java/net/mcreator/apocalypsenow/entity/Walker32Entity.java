...
public class Walker32Entity extends Monster {
   public Walker32Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.WALKER_32.get(), world);
   }

   public Walker32Entity(EntityType<Walker32Entity> type, Level world) {
      super(type, world);
   ...
   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.WALKER_32.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
      ...
      DungeonHooks.addDungeonMob(ApocalypsenowModEntities.WALKER_32.get(), 180);
   }

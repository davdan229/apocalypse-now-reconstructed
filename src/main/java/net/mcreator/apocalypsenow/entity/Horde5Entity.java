...
import net.mcreator.apocalypsenow.procedures.Horde5oninitialspawnProcedure;
...
public class Horde5Entity extends Monster {
   public Horde5Entity(SpawnEntity packet, Level world) {
      this(ApocalypsenowModEntities.HORDE_5.get(), world);
   }

   public Horde5Entity(EntityType<Horde5Entity> type, Level world) {
      super(type, world);
   ...
   public SpawnGroupData finalizeSpawn(
      ...
      Horde5oninitialspawnProcedure.execute(world, this.getX(), this.getY(), this.getZ());
      return retval;
   }

   public static void init() {
      SpawnPlacements.register(
         ApocalypsenowModEntities.HORDE_5.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();

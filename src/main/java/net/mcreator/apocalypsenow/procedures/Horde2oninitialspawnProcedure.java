...
public class Horde2oninitialspawnProcedure {
      ...
      if (Math.random() < 0.2) {
         ApocalypsenowMod.queueServerWork(
            ...
            () -> {
               ...
               if (world instanceof ServerLevel _level) {
                  Entity entityToSpawn = ApocalypsenowModEntities.WALKER_20.get().spawn(_level, BlockPos.containing(x - 4.0, y, z), MobSpawnType.MOB_SUMMONED);
                  if (entityToSpawn != null) {
                     entityToSpawn.setYRot(world.getRandom().nextFloat() * 360.0F);
                  }
               }

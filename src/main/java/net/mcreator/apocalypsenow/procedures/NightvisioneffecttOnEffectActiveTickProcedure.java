...
public class NightvisioneffecttOnEffectActiveTickProcedure {
   public static void execute(Entity entity) {
      if (entity != null) {
         ...
         if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem()
               != ApocalypsenowModItems.SPEC_OPS_HELMET.get()
            && entity instanceof LivingEntity _entity) {
            _entity.removeEffect(ApocalypsenowModMobEffects.NIGHTVISIONEFFECTT.get());
         }
      }
   }
}

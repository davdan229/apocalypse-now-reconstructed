...
public class ClimbingropeextensionupdatetickProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      if (world.getBlockState(BlockPos.containing(x, y - 1.0, z)).getBlock() == Blocks.AIR) {
         world.setBlock(BlockPos.containing(x, y - 1.0, z), ApocalypsenowModBlocks.CLIMBINGROPEEXTENSION.get().defaultBlockState(), 3);

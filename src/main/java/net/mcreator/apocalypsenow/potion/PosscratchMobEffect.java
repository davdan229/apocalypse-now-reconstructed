...
import net.mcreator.apocalypsenow.procedures.PosscratcheffectProcedure;
...
public class PosscratchMobEffect extends MobEffect {
   public PosscratchMobEffect() {
      super(MobEffectCategory.NEUTRAL, -1);
   }

   @Override
   public void applyEffectTick(LivingEntity entity, int amplifier) {
      PosscratcheffectProcedure.execute(entity);
   }

...
import net.mcreator.apocalypsenow.procedures.PosinfectionProcedure;
...
public class PosinfectioneffectMobEffect extends MobEffect {
   public PosinfectioneffectMobEffect() {
      super(MobEffectCategory.NEUTRAL, -1);
   }

   @Override
   public void applyEffectTick(LivingEntity entity, int amplifier) {
      PosinfectionProcedure.execute(entity);
   }

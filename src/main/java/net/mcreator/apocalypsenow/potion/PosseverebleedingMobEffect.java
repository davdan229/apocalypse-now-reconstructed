...
import net.mcreator.apocalypsenow.procedures.PosseverebleedingeffectProcedure;
...
public class PosseverebleedingMobEffect extends MobEffect {
   public PosseverebleedingMobEffect() {
      super(MobEffectCategory.NEUTRAL, -1);
   }

   @Override
   public void applyEffectTick(LivingEntity entity, int amplifier) {
      PosseverebleedingeffectProcedure.execute(entity);
   }

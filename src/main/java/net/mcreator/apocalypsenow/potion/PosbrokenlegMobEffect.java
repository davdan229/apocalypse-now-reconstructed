...
import net.mcreator.apocalypsenow.procedures.PosbrokenlegOnEffectActiveTickProcedure;
...
public class PosbrokenlegMobEffect extends MobEffect {
   public PosbrokenlegMobEffect() {
      super(MobEffectCategory.NEUTRAL, -1);
   }

   @Override
   public void applyEffectTick(LivingEntity entity, int amplifier) {
      PosbrokenlegOnEffectActiveTickProcedure.execute(entity);
   }

...
import net.mcreator.apocalypsenow.procedures.PosbleedingeffectProcedure;
...
public class PosbleedingMobEffect extends MobEffect {
   public PosbleedingMobEffect() {
      super(MobEffectCategory.NEUTRAL, -1);
   }

   @Override
   public void applyEffectTick(LivingEntity entity, int amplifier) {
      PosbleedingeffectProcedure.execute(entity);
   }

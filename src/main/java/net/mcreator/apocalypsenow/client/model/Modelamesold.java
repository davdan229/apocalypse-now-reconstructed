...
public class Modelamesold<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelamesold"), "main");
   ...
   public Modelamesold(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(43, 2)
            .addBox(-4.0F, -1.0F, -3.0F, 2.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(38, 19)
            .addBox(2.0F, -1.0F, -3.0F, 2.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(27, 0)
            .addBox(1.5F, 3.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 5)
            .addBox(-0.5F, 9.0F, 3.0F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(18, 22)
            .addBox(-3.5F, 3.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 8)
            .addBox(-1.0F, 3.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),

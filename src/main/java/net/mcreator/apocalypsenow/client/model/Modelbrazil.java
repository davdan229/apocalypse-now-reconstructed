...
public class Modelbrazil<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelbrazil"), "main");
   ...
   public Modelbrazil(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(60, 34)
            .addBox(-3.5F, 0.7F, -3.6F, 2.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 24)
            .addBox(1.5F, 0.7F, -3.6F, 2.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(44, 47)
      ...
      PartDefinition cube_r1 = RightLeg.addOrReplaceChild(
         "cube_r1",
         CubeListBuilder.create().texOffs(58, 10).addBox(-2.0F, 8.6F, -7.8F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition cube_r2 = LeftLeg.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(64, 0).addBox(-2.0F, 8.6F, -7.6F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.4363F, 0.0F, 0.0F)
      );

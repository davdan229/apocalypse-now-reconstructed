...
public class Modelgeneral<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelgeneral"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(119, 24)
            .addBox(-1.0F, 2.0F, -2.705F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(122, 24)
            .addBox(0.0F, 2.0F, -2.705F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(117, 17)

...
public class Modelgrandebelt<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelgrandebelt"), "main");
   public final ModelPart Body;
   public final ModelPart RightArm;
   public final ModelPart LeftArm;

   public Modelgrandebelt(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition cube_r12 = Body.addOrReplaceChild(
         "cube_r12",
         CubeListBuilder.create().texOffs(12, 5).addBox(-1.0F, 9.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-7.5F, -6.2F, -2.1F, 0.0F, 0.0F, -0.5672F)
      );
      PartDefinition cube_r13 = Body.addOrReplaceChild(
         "cube_r13",
         CubeListBuilder.create().texOffs(0, 14).addBox(-1.0F, 9.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-7.5F, -7.2F, -2.6F, 0.0F, 0.0F, -0.5672F)
      );
      PartDefinition cube_r14 = Body.addOrReplaceChild(
         "cube_r14",
         CubeListBuilder.create().texOffs(12, 5).addBox(-1.0F, 9.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-5.7F, -3.5F, -2.1F, 0.0F, 0.0F, -0.5672F)
      );
      PartDefinition cube_r15 = Body.addOrReplaceChild(
         "cube_r15",
         CubeListBuilder.create().texOffs(0, 14).addBox(-1.0F, 9.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-5.7F, -4.5F, -2.6F, 0.0F, 0.0F, -0.5672F)
      );
      PartDefinition cube_r16 = Body.addOrReplaceChild(
         "cube_r16",
         CubeListBuilder.create().texOffs(12, 5).addBox(-1.0F, 9.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-4.1F, -1.0F, -2.1F, 0.0F, 0.0F, -0.5672F)
      );
      PartDefinition cube_r17 = Body.addOrReplaceChild(
         "cube_r17",
         CubeListBuilder.create().texOffs(0, 14).addBox(-1.0F, 9.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-4.1F, -2.0F, -2.6F, 0.0F, 0.0F, -0.5672F)
      );
      PartDefinition cube_r18 = Body.addOrReplaceChild(
         "cube_r18",
         CubeListBuilder.create().texOffs(0, 14).addBox(-1.0F, 9.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-2.5F, 0.5F, -2.6F, 0.0F, 0.0F, -0.5672F)
      );

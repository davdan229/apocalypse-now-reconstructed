...
public class Modelingles<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelingles"), "main");
   ...
   public Modelingles(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(0, 29)
            .addBox(-3.5F, 5.0F, -4.0F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 10)
            .addBox(1.5F, 5.0F, -4.0F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(56, 59)
            .addBox(-0.5F, 2.0F, -3.6F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-1.0F, 5.0F, -4.0F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(44, 47)
      ...
      PartDefinition cube_r2 = LeftLeg.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(58, 10).addBox(-2.0F, 8.6F, -7.6F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.4363F, 0.0F, 0.0F)
      );

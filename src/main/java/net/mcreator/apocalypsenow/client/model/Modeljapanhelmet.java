...
public class Modeljapanhelmet<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modeljapanhelmet"), "main");
   ...
   public Modeljapanhelmet(ModelPart root) {

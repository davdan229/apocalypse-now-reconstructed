...
public class Modelswatriotar<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelswatriotar"), "main");
   ...
   public Modelswatriotar(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(99, 87)
            .addBox(-5.0F, -8.3F, -5.2F, 10.0F, 9.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(3, 2)
      ...
      PartDefinition RightArm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(75, 65)
            .addBox(-4.5F, -0.4F, -2.5F, 1.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
            .texOffs(10, 47)
      ...
      PartDefinition LeftArm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .addBox(3.5F, -2.4F, -2.5F, 0.0F, 10.0F, 5.0F, new CubeDeformation(0.0F))
            .texOffs(68, 92)
            .addBox(3.5F, -0.4F, -2.5F, 1.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
            .texOffs(50, 44)
            .addBox(-1.5F, -0.4F, -2.5F, 0.0F, 8.0F, 5.0F, new CubeDeformation(0.0F))
            .texOffs(43, 19)
      ...
      PartDefinition RightLeg = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(12, 121)
            .addBox(-2.4F, 2.0F, -3.999F, 5.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition cube_r2 = RightLeg.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(92, 22).addBox(-4.995F, -1.0F, -1.0F, 5.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(2.6F, 10.1F, -5.2F, 0.7679F, 0.0F, 0.0F)
      );
      PartDefinition LeftLeg = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(12, 121)
            .addBox(-2.6F, 2.0F, -4.0F, 5.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offset(1.9F, 12.0F, 0.0F)
      );
      PartDefinition cube_r3 = LeftLeg.addOrReplaceChild(
         "cube_r3",
         CubeListBuilder.create().texOffs(92, 22).addBox(-4.995F, -1.0F, -1.0F, 5.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(2.4F, 10.1F, -5.2F, 0.7679F, 0.0F, 0.0F)
      );

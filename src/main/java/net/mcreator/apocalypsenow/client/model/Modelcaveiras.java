...
public class Modelcaveiras<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelcaveiras"), "main");
   public final ModelPart bb_main;
   public final ModelPart bb_main2;

   public Modelcaveiras(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition bb_main = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(18, 19)
            .addBox(-3.0F, -7.0F, -7.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-4.0F, -1.0F, -8.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(24, 10)
            .addBox(-3.0F, -4.0F, -8.0F, 6.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(24, 0)
            .addBox(-3.0F, -7.0F, -8.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(24, 1)
            .addBox(-4.0F, -8.0F, -8.0F, 5.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(42, 0)
            .addBox(1.0F, -8.0F, -6.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(0, 41)
            .addBox(3.0F, -8.0F, -7.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
            .texOffs(41, 30)
            .addBox(-4.0F, -7.0F, -1.0F, 8.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(32, 31)
            .addBox(-4.0F, -7.0F, -8.0F, 1.0F, 6.0F, 7.0F, new CubeDeformation(0.0F))
            .texOffs(16, 31)
            .addBox(3.0F, -7.0F, -8.0F, 1.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition cube_r1 = bb_main.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(36, 10)
            .addBox(4.0F, -9.0F, 0.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(0, 4)
            .addBox(5.0F, -11.0F, 1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.5708F, 0.0F, 0.0F)
      );
      PartDefinition cube_r2 = bb_main.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(0, 9).addBox(-4.0F, -12.0F, -4.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 0.0F)
      );

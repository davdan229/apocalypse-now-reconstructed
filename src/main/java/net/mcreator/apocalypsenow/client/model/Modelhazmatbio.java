...
public class Modelhazmatbio<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelhazmatbio"), "main");
   ...
   public Modelhazmatbio(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(94, 109)
            .addBox(-4.6F, -3.405F, -4.7F, 9.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(90, 119)
            .addBox(-4.6F, -7.605F, -4.7F, 9.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(113, 96)
            .addBox(-1.0F, -6.405F, -4.6F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 59)
      ...
      PartDefinition cube_r1 = Head.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(-1.9F, 0.2F, -6.0F, -0.0802F, 0.454F, -0.169F)
      );
      ...
      PartDefinition cube_r3 = Head.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(0.0F, -0.1F, -7.2F, -0.1396F, 0.0F, 0.0F)
      );
      PartDefinition cube_r4 = Head.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(-0.1F, 0.1F, -6.5F, -0.1396F, 0.0F, 0.0F)
      );
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(45, 35)
            .addBox(-2.5F, 3.991F, -2.6F, 5.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(21, 36)
      ...
      PartDefinition cube_r9 = LeftLeg.addOrReplaceChild(
         "cube_r9",

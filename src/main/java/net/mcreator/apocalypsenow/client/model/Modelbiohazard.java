...
public class Modelbiohazard<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelbiohazard"), "main");
   ...
   public Modelbiohazard(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(40, 0)
            .addBox(-4.0F, -8.0F, -4.6F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(31, 47)
            .addBox(-1.0F, -4.0F, -4.6F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(40, 3)
            .addBox(-3.0F, -6.0F, -4.2F, 6.0F, 3.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(45, 46)
            .addBox(-1.0F, -3.0F, -5.6F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 16)
            .addBox(3.0F, -6.0F, -4.6F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(16, 32)
            .addBox(-4.0F, -6.0F, -4.6F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
      ...
      PartDefinition Head_r5 = Head.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(46, 13)
            .addBox(1.0F, -2.7F, -5.1F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(0, 12)
            .addBox(0.5F, -3.2F, -7.1F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0521F, 0.5783F, -0.188F)
      );
      PartDefinition Head_r6 = Head.addOrReplaceChild(
         "Head_r6",
         CubeListBuilder.create()
            .texOffs(0, 0)
            .addBox(-3.4F, -3.2F, -6.7F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(44, 32)
            .addBox(-2.9F, -2.7F, -4.7F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(48, 23)
            .addBox(-2.3F, 2.0F, -2.2F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(48, 22)
            .addBox(-2.3F, 6.0F, -2.2F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(22, 48)
            .addBox(1.7F, 6.0F, -2.2F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(48, 21)
            .addBox(1.7F, 2.0F, -2.2F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(48, 20)
            .addBox(0.7F, 3.0F, -2.2F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(20, 48)
            .addBox(0.7F, 5.0F, -2.2F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(18, 48)
            .addBox(-1.3F, 5.0F, -2.2F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(16, 48)
            .addBox(-1.3F, 3.0F, -2.2F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(40, 15)
            .addBox(-1.3F, 4.0F, -2.2F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(40, 20)

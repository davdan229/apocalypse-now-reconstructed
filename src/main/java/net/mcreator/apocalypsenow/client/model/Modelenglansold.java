...
public class Modelenglansold<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelenglansold"), "main");
   ...
   public Modelenglansold(ModelPart root) {

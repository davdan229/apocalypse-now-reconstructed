...
public class Modelplate<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelplate"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(36, 28)
            .addBox(-2.5F, 8.5F, -3.5F, 5.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 13)
            .addBox(0.5F, 1.5F, -4.0F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 26)
      ...
      PartDefinition cube_r2 = Body.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(22, 13).addBox(4.1F, -1.7F, -2.1F, 6.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.4F, 0.4F, 0.0F, 0.0F, 0.1745F)
      );
      PartDefinition cube_r3 = Body.addOrReplaceChild(
         "cube_r3",
         CubeListBuilder.create().texOffs(28, 0).addBox(-9.9F, -1.7F, -2.1F, 6.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),

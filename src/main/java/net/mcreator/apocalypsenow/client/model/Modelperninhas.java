...
public class Modelperninhas<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelperninhas"), "main");
   public final ModelPart bb_main;

   public Modelperninhas(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition bb_main = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(0, 0)
            .addBox(-4.0F, -8.0F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(46, 46)
            .addBox(-3.0F, -3.0F, 18.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),

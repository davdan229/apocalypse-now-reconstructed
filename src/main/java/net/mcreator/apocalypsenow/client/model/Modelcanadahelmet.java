...
public class Modelcanadahelmet<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelcanadahelmet"), "main");
   ...
   public Modelcanadahelmet(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition tankersixbod_r3 = Body.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(2.4F, -6.4F, 0.5F, 0.0F, 0.0F, 0.1222F)
      );
      PartDefinition tankersixbod_r4 = Body.addOrReplaceChild(
         "tankersixbod_r4",
         CubeListBuilder.create().texOffs(70, 87).addBox(-2.2F, 8.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.9F, -6.3F, 0.5F, 0.0F, 0.0F, 0.1222F)
      );
      PartDefinition tankersixbod_r5 = Body.addOrReplaceChild(
         "tankersixbod_r5",
         CubeListBuilder.create().texOffs(70, 87).addBox(-2.2F, 8.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-0.2F, -6.4F, 0.5F, 0.0F, 0.0F, 0.1222F)
      );

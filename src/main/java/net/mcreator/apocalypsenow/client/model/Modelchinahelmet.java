...
public class Modelchinahelmet<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelchinahelmet"), "main");
   ...
   public Modelchinahelmet(ModelPart root) {

...
public class Modelnvg<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelnvg"), "main");
   ...
   public Modelnvg(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(0, 12)
            .addBox(-3.1F, -5.5F, -6.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(10, 9)
            .addBox(1.1F, -5.5F, -6.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 5)
            .addBox(-1.5F, -5.8F, -5.7F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 9)
            ...
            .texOffs(10, 10)
            .addBox(3.5F, -4.9F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(0, 9)
            .addBox(-4.5F, -4.9F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)),

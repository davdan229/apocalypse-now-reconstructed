...
public class Modelperninhaas<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelperninhaas"), "main");
   public final ModelPart bb_main;

   public Modelperninhaas(ModelPart root) {

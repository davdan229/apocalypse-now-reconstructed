...
public class Modelmexihelmet<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelmexihelmet"), "main");
   ...
   public Modelmexihelmet(ModelPart root) {

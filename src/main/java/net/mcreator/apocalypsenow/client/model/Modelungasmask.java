...
public class Modelungasmask<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelungasmask"), "main");
   ...
   public Modelungasmask(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .addBox(4.5F, -2.5F, -3.6F, 0.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(110, 21)
            .addBox(-4.5F, -0.1F, -4.7F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(110, 21)
            .addBox(-4.499F, -8.1F, -4.7F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(96, 46)
            .addBox(-3.499F, -7.1F, -4.7F, 7.0F, 6.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(110, 21)
            .addBox(-4.5F, -7.1F, -4.7F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(110, 21)
            .addBox(3.405F, -7.1F, -4.7F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, -2.0F, 0.0F)
      );
      PartDefinition cube_r1 = Head.addOrReplaceChild(
         "cube_r1",
         CubeListBuilder.create().texOffs(116, 18).addBox(-2.0F, -3.0F, 0.0F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-0.1F, 0.8F, -6.5F, 0.0349F, 0.0F, 0.0F)
      );
      PartDefinition cube_r2 = Head.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(114, 13).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.6F, -7.2F, 0.0349F, 0.0F, 0.0F)
      );
      PartDefinition cube_r3 = Head.addOrReplaceChild(
         "cube_r3",
         CubeListBuilder.create().texOffs(116, 31).addBox(-2.0F, -2.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-1.9F, 0.9F, -6.0F, 0.1135F, 0.476F, -0.0819F)
      );
      PartDefinition cube_r4 = Head.addOrReplaceChild(
         "cube_r4",
         CubeListBuilder.create().texOffs(116, 31).addBox(-2.0F, -2.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(3.0F, 0.9F, -6.0F, 0.2493F, -0.5058F, -0.0193F)
      );
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(70, 87)
            .addBox(0.3F, 6.5F, -3.5F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(69, 87)
            .addBox(-0.5F, 1.0F, -3.5F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(70, 87)
            .addBox(-2.3F, 6.4F, -3.5F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(70, 87)
            .addBox(-3.2F, 1.0F, -3.5F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(114, 78)

...
public class Modeljug<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modeljug"), "main");
   ...
   public Modeljug(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(25, 6)
            .addBox(-5.0F, -9.0F, -6.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(28, 10)
            .addBox(-5.0F, -8.0F, -6.0F, 10.0F, 6.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            ...
            .texOffs(14, 12)
            .addBox(4.0F, -2.0F, -5.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F))
            .texOffs(25, 0)
            .addBox(-6.0F, -2.0F, -6.0F, 12.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(25, 3)
            .addBox(-5.0F, -2.0F, 5.0F, 10.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 10)
            .addBox(-6.0F, -2.0F, -5.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)),

...
public class Modelpants<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelpants"), "main");
   public final ModelPart RightLeg;
   public final ModelPart LeftLeg;

   public Modelpants(ModelPart root) {

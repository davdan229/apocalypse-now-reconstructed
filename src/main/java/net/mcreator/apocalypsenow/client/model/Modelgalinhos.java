...
public class Modelgalinhos<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelgalinhos"), "main");
   public final ModelPart bb_main;

   public Modelgalinhos(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition cube_r1 = bb_main.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .addBox(4.0F, -12.0F, 0.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(32, 24)
            .addBox(-1.0F, -4.0F, 8.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-1.0F, -3.0F, 11.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 3)
            .addBox(-1.0F, -1.0F, 12.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),

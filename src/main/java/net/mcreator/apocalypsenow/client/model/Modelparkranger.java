...
public class Modelparkranger<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelparkranger"), "main");
   ...
   public Modelparkranger(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(119, 24)
            .addBox(-1.0F, 2.0F, -2.705F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(122, 24)
            .addBox(0.0F, 2.0F, -2.705F, 1.0F, 7.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(107, 20)
            .addBox(-4.0F, 9.9F, -2.905F, 8.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(107, 20)
            .addBox(-4.0F, 9.9F, 2.695F, 8.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(101, 14)
            .addBox(-4.1F, 9.9F, -3.105F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(111, 14)
            .addBox(4.2F, 9.9F, -3.205F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(117, 17)
      ...
      PartDefinition cube_r4 = Body.addOrReplaceChild(
         "cube_r4",
         CubeListBuilder.create().texOffs(99, 42).addBox(3.0F, 8.0F, 0.995F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(6.0F, -6.0F, -3.7F, 0.0F, 0.0F, 0.7854F)
      );

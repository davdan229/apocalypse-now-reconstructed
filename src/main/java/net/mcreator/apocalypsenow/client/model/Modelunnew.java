...
public class Modelunnew<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelunnew"), "main");
   ...
   public Modelunnew(ModelPart root) {

...
public class Modelriotar<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelriotar"), "main");
   ...
   public Modelriotar(ModelPart root) {

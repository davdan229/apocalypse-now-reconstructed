...
public class Modelamerica<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelamerica"), "main");
   ...
   public Modelamerica(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(39, 29)
            .addBox(-4.5F, 3.0F, -2.0F, 9.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(2, 2)
            .addBox(-4.5F, 2.0F, -2.0F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 2)
            .addBox(4.5F, 2.0F, -2.0F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-5.0F, 2.8F, -2.0F, 0.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-4.5F, -6.0F, -4.6F, 9.0F, 0.0F, 9.0F, new CubeDeformation(0.0F))
            .texOffs(51, 43)
            .addBox(-4.5F, -6.0F, -4.6F, 9.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(51, 39)
            .addBox(-4.0F, -6.2F, -5.2F, 8.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(3, 2)
            .addBox(-5.0F, -4.9F, -5.1F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(18, 11)
            .addBox(-5.0F, -4.9F, -5.1F, 0.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
            .texOffs(18, 0)
            .addBox(5.0F, -4.9F, -5.1F, 0.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
            .texOffs(40, 28)
            .addBox(-5.0F, -4.9F, 4.9F, 10.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(3, 1)
            .addBox(4.0F, -4.9F, -5.1F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 15)
            .addBox(-4.0F, -3.2F, -5.2F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 13)
            .addBox(1.0F, -3.2F, -5.2F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(48, 24)
            .addBox(-3.5F, 2.0F, 4.4F, 7.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(36, 11)
            .addBox(-4.5F, -6.0F, 4.4F, 9.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-4.5F, 2.0F, 4.4F, 9.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 16)
            .addBox(4.5F, -6.0F, -4.6F, 0.0F, 6.0F, 9.0F, new CubeDeformation(0.0F))
            .texOffs(0, 10)
            .addBox(-4.5F, -6.0F, -4.6F, 0.0F, 6.0F, 9.0F, new CubeDeformation(0.0F))
            .texOffs(16, 32)
            .addBox(-4.5F, 0.0F, -3.6F, 0.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(27, 0)
            .addBox(4.5F, 0.0F, -3.6F, 0.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),

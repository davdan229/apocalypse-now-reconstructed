...
public class Modelcivilian<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelcivilian"), "main");
   ...
   public Modelcivilian(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(30, 4)
            .addBox(-1.1F, 2.7F, -3.6F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(27, 29)
            ...
            .texOffs(30, 18)
            .addBox(-3.4F, 2.7F, -3.6F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(0, 12)
      ...
      PartDefinition cube_r1 = Body.addOrReplaceChild(
         "cube_r1",
         CubeListBuilder.create().texOffs(9, 24).addBox(-1.0F, 7.0F, -1.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-3.7F, 0.0F, -1.9F, 0.0F, 0.829F, 0.0F)
      );
      PartDefinition cube_r2 = Body.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(30, 24).addBox(-1.0F, 7.0F, 0.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),

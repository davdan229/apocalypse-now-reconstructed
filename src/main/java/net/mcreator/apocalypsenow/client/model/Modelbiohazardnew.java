...
public class Modelbiohazardnew<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelbiohazardnew"), "main");
   ...
   public Modelbiohazardnew(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(34, 29)
            .addBox(-0.5F, -8.6F, -4.2F, 1.0F, 0.0F, 9.0F, new CubeDeformation(0.0F))
            .texOffs(1, 0)
            .addBox(-0.5F, -8.7F, 4.1F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 37)
            .addBox(-0.5F, -8.7F, 5.1F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-0.5F, -8.6F, 5.0F, 1.0F, 7.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(43, 36)
            ...
            .texOffs(43, 39)
            .addBox(-4.6F, -2.405F, -4.7F, 9.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(43, 14)
            .addBox(-4.6F, -7.605F, -4.7F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(16, 36)
            .addBox(-1.0F, -3.405F, -4.7F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 45)
            .addBox(-4.0F, -6.505F, -4.3F, 8.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, 0.0F, 0.0F)
      );
      PartDefinition cube_r1 = Head.addOrReplaceChild(
         "cube_r1",
         CubeListBuilder.create().texOffs(40, 49).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-1.6F, 0.2F, -5.0F, -0.0848F, 0.5768F, -0.1204F)
      );
      PartDefinition cube_r2 = Head.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(25, 0).addBox(-2.0F, -2.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(3.0F, 0.2F, -6.0F, 0.0501F, -0.5008F, 0.077F)
      );
      PartDefinition cube_r3 = Head.addOrReplaceChild(
         "cube_r3",
         CubeListBuilder.create().texOffs(0, 34).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.1F, -0.3F, -6.5F, -0.1396F, 0.0F, 0.0F)
      );
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(45, 35)
            .addBox(-2.5F, 9.991F, -2.6F, 5.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(21, 36)

...
public class Modelrusssoldp<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelrusssoldp"), "main");
   public final ModelPart RightLeg;
   public final ModelPart LeftLeg;

   public Modelrusssoldp(ModelPart root) {

...
public class Modelorangeblack<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelorangeblack"), "main");
   ...
   public Modelorangeblack(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(30, 14)
            .addBox(4.0F, -4.7F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(3, 55)
            .addBox(-1.0F, -8.7F, -4.0F, 2.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(9, 59)
            .addBox(-1.0F, -7.7F, 4.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(25, 0)
            .addBox(-5.0F, -4.7F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(35, 6)
            .addBox(-4.0F, -4.7F, 4.0F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition cube_r3 = Head.addOrReplaceChild(
         "cube_r3",
         CubeListBuilder.create().texOffs(31, 56).addBox(3.2F, -3.4F, -6.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.0F, -0.6F, -0.0416F, 0.0131F, 0.3052F)
      );
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(0, 40)
            .addBox(-3.9F, -0.2F, -2.6F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
            .texOffs(20, 10)
            ...
            .texOffs(10, 10)
            .addBox(0.7F, 7.0F, -3.6F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(11, 44)
            .addBox(3.3F, 8.0F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(40, 14)
            .addBox(-5.4F, 7.5F, -1.2F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(52, 58)
            .addBox(-0.4F, 2.0F, -3.2F, 4.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(36, 39)
            .addBox(-3.7F, 8.2F, 1.8F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(0, 10)
            .addBox(-2.8F, 7.0F, -3.6F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-3.1F, 2.0F, -3.5F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(27, 27)

...
public class Modeljapansold<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modeljapansold"), "main");
   ...
   public Modeljapansold(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(70, 87)
            .addBox(-2.5F, 5.8F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(70, 87)
            .addBox(0.0F, 5.8F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(114, 78)
            ...
            .texOffs(87, 73)
            .addBox(-4.0F, 1.0F, -3.2F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(87, 73)
            .addBox(-4.0F, 3.0F, -3.2F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(87, 73)
            .addBox(-4.0F, 5.0F, -3.2F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(87, 73)
            .addBox(-4.0F, 7.0F, -3.2F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(88, 73)
            .addBox(-3.0F, 9.0F, -3.2F, 6.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(88, 73)
            .addBox(-3.0F, 9.0F, 3.2F, 6.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(87, 73)
            .addBox(-4.0F, 7.0F, 3.2F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
      ...
      PartDefinition tankersixbod_r1 = Body.addOrReplaceChild(
         "tankersixbod_r1",
         CubeListBuilder.create().texOffs(69, 86).addBox(-2.2F, 8.0F, -4.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-1.2F, -2.2F, -0.2F, 0.0F, 0.4363F, 0.0F)
      );
      PartDefinition tankersixbod_r2 = Body.addOrReplaceChild(
         "tankersixbod_r2",
         CubeListBuilder.create().texOffs(91, 108).addBox(0.5F, 8.0F, -4.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.6F, -2.2F, -0.6F, 0.0F, -0.5411F, 0.0F)
      );

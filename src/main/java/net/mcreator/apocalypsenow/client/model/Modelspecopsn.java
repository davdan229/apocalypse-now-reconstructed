...
public class Modelspecopsn<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelspecopsn"), "main");
   ...
   public Modelspecopsn(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(61, 110)
            .addBox(-4.1F, 9.0F, -3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(61, 110)
            .addBox(-4.1F, 7.0F, -3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(61, 110)
            .addBox(-4.1F, 5.0F, -3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(61, 110)
            .addBox(-4.1F, 3.0F, -3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(61, 110)
            .addBox(-4.1F, 1.0F, -3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(61, 110)
            .addBox(-4.1F, -1.0F, -3.1F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(61, 110)
            .addBox(0.9F, -1.0F, -3.1F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(61, 110)
            .addBox(0.9F, -1.0F, 3.1F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(61, 110)
            .addBox(-4.1F, -1.0F, 3.1F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            ...
            .addBox(-4.1F, 7.0F, 3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(62, 110)
            .addBox(-3.1F, 9.0F, 3.1F, 6.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(91, 94)
            ...
            .texOffs(69, 87)
            .addBox(-0.7F, 1.2F, -3.5F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(69, 87)
            .addBox(1.5F, 1.2F, -3.5F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(70, 87)
      ...
      PartDefinition tankersixbod_r3 = Body.addOrReplaceChild(
         "tankersixbod_r3",
         CubeListBuilder.create().texOffs(70, 87).addBox(-2.2F, 8.0F, -4.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.7F, -8.1F, 0.5F, 0.0F, 0.0F, 0.2094F)
      );

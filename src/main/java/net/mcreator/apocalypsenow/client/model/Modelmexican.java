...
public class Modelmexican<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelmexican"), "main");
   ...
   public Modelmexican(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(25, 18)
            .addBox(-6.0F, -6.0F, -3.0F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(25, 18)
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(52, 48)
            .addBox(2.0F, 6.0F, -4.0F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(42, 0)
            .addBox(2.0F, 3.0F, -4.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(51, 42)
            .addBox(-4.0F, 6.0F, -4.0F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(26, 36)
            .addBox(-1.0F, 6.0F, -4.0F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(16, 48)
      ...
      PartDefinition RightArm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(0, 16)
            .addBox(-4.0F, -1.0F, -1.5F, 1.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition LeftArm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(0, 0)
            .addBox(3.0F, -1.0F, -1.5F, 1.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offset(5.0F, 2.0F, 0.0F)
      );
      ...
      PartDefinition cube_r1 = RightLeg.addOrReplaceChild(
         "cube_r1",
         CubeListBuilder.create().texOffs(36, 21).addBox(-1.9F, 9.0F, 2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition cube_r2 = LeftLeg.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(51, 38).addBox(-2.1F, 9.0F, 2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.4363F, 0.0F, 0.0F)
      );

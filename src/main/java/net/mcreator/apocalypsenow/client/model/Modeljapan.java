...
public class Modeljapan<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modeljapan"), "main");
   ...
   public Modeljapan(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(10, 55)
            .addBox(-2.4F, -12.1F, -5.1F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
            .texOffs(10, 9)
            .addBox(-1.4F, -13.1F, -3.1F, 2.0F, 2.0F, 3.1F, new CubeDeformation(0.0F))
            .texOffs(0, 9)
      ...
      PartDefinition cube_r1 = Head.addOrReplaceChild(
         "cube_r1",
         CubeListBuilder.create().texOffs(24, 0).addBox(-2.0F, -9.0F, -7.4F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(60, 30)
            .addBox(-1.0F, 9.0F, 3.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 31)
      ...
      PartDefinition RightArm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(46, 31)
            .addBox(-4.0F, -2.4F, -2.0F, 5.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(56, 17)
      ...
      PartDefinition LeftArm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(44, 2)
            .addBox(-1.0F, -2.4F, -2.0F, 5.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(30, 32)

...
public class Modelmexicosol<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelmexicosol"), "main");
   ...
   public Modelmexicosol(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(102, 119)
            .addBox(1.3F, 1.9F, -4.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(88, 124)
            .addBox(-3.5F, 1.3F, -4.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(70, 87)
            .addBox(-2.5F, 6.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(70, 87)
            .addBox(0.0F, 6.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(114, 78)
      ...
      PartDefinition tankersixbod_r1 = Body.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(-1.2F, -2.0F, -0.2F, 0.0F, 0.4363F, 0.0F)
      );
      PartDefinition tankersixbod_r2 = Body.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(0.6F, -2.0F, -0.6F, 0.0F, -0.5411F, 0.0F)
      );

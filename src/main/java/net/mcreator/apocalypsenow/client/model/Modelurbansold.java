...
public class Modelurbansold<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelurbansold"), "main");
   ...
   public Modelurbansold(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(92, 74)
            .addBox(-0.8F, 8.2F, 2.9F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(114, 78)
      ...
      PartDefinition tankersixbod_r3 = Body.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(2.4F, -6.9F, 0.5F, 0.0F, 0.0F, 0.1222F)
      );
      PartDefinition tankersixbod_r4 = Body.addOrReplaceChild(
         "tankersixbod_r4",
         CubeListBuilder.create().texOffs(70, 87).addBox(-2.2F, 8.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(1.1F, -1.8F, 0.5F, 0.0F, 0.0F, 0.1222F)
      );
      PartDefinition tankersixbod_r5 = Body.addOrReplaceChild(
         "tankersixbod_r5",
         CubeListBuilder.create().texOffs(70, 87).addBox(-2.2F, 8.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(3.9F, -1.8F, 0.5F, 0.0F, 0.0F, 0.1222F)
      );
      PartDefinition tankersixbod_r6 = Body.addOrReplaceChild(
         "tankersixbod_r6",
         CubeListBuilder.create().texOffs(70, 87).addBox(-2.2F, 8.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.9F, -6.8F, 0.5F, 0.0F, 0.0F, 0.1222F)
      );
      PartDefinition tankersixbod_r7 = Body.addOrReplaceChild(
         "tankersixbod_r7",
         CubeListBuilder.create().texOffs(70, 87).addBox(-2.2F, 8.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-0.2F, -6.9F, 0.5F, 0.0F, 0.0F, 0.1222F)
      );

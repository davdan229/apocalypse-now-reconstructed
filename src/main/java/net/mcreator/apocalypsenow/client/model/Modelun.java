...
public class Modelun<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelun"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(48, 49)
            .addBox(-5.0F, -8.0F, -6.0F, 10.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(55, 11)
            .addBox(-5.0F, -5.0F, -6.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(45, 11)
            .addBox(1.0F, -5.0F, -6.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(26, 17)
            .addBox(1.0F, 7.0F, 3.0F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(26, 24)
      ...
      PartDefinition RightArm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(0, 27)
            .addBox(-3.1F, -3.0F, -3.0F, 4.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition LeftArm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(29, 27)
            .addBox(-0.9F, -3.0F, -3.0F, 4.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
         PartPose.offset(5.0F, 2.0F, 0.0F)
      );
      ...
      PartDefinition cube_r1 = RightLeg.addOrReplaceChild(
         "cube_r1",
         CubeListBuilder.create().texOffs(15, 54).addBox(-2.0F, 9.0F, 2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition cube_r2 = LeftLeg.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(0, 55).addBox(-2.1F, 9.0F, 2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.4363F, 0.0F, 0.0F)
      );

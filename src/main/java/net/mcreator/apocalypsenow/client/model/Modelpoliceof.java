...
public class Modelpoliceof<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelpoliceof"), "main");
   ...
   public Modelpoliceof(ModelPart root) {

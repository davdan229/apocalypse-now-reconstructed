...
public class Modelsalvavidas<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelsalvavidas"), "main");
   ...
   public Modelsalvavidas(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(4, 0)
            .addBox(-5.0F, -8.0F, -5.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(4.0F, -8.0F, -5.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(10, 9)
            .addBox(4.5F, -6.3F, -4.4F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(0, 9)
            .addBox(-5.5F, -6.3F, -4.4F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(24, 0)
            .addBox(-4.0F, -8.0F, -6.0F, 8.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 38)
            .addBox(-3.5F, -6.7F, -6.4F, 7.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(10, 15)
            ...
            .texOffs(38, 14)
            .addBox(-3.0F, -2.0F, 4.0F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(38, 9)
            .addBox(2.0F, -0.4F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(38, 4)
            .addBox(-4.0F, -0.4F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(28, 19)
            .addBox(-4.0F, 2.0F, -3.0F, 8.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(28, 29)
            .addBox(4.0F, 2.0F, -2.0F, 1.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(18, 29)
            .addBox(-5.0F, 2.0F, -2.0F, 1.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(20, 9)

...
public class Modelamesoldp<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelamesoldp"), "main");
   public final ModelPart RightLeg;
   public final ModelPart LeftLeg;

   public Modelamesoldp(ModelPart root) {

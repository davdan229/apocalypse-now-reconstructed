...
public class Modelchinasold<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelchinasold"), "main");
   ...
   public Modelchinasold(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(70, 87)
            .addBox(-2.5F, 7.3F, -4.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(70, 87)
            .addBox(1.5F, 1.0F, -3.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(70, 87)
            .addBox(0.0F, 7.3F, -4.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(114, 78)
      ...
      PartDefinition cube_r1 = LeftArm.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(4.5F, 2.4F, -0.8F, 0.7854F, 0.0F, 0.0F)
      );

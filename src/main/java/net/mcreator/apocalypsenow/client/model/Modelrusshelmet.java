...
public class Modelrusshelmet<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelrusshelmet"), "main");
   ...
   public Modelrusshelmet(ModelPart root) {

...
public class Modelbrassold<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelbrassold"), "main");
   ...
   public Modelbrassold(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(87, 73)
            .addBox(-4.0F, 10.0F, -3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(88, 73)
            .addBox(-3.0F, 12.0F, -3.1F, 6.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(87, 73)
            .addBox(-4.0F, 8.0F, -3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(87, 73)
            .addBox(-4.0F, 6.0F, -3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(87, 73)
            .addBox(-4.0F, 4.0F, -3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(87, 73)
            .addBox(-4.0F, 2.0F, -3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(87, 73)
            .addBox(-4.0F, 2.0F, 3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(87, 73)
            .addBox(-4.0F, 4.0F, 3.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            ...
            .addBox(-3.0F, 12.0F, 3.1F, 6.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(92, 109)
            .addBox(1.5F, 6.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(102, 119)
            .addBox(-3.0F, 2.1F, -4.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(70, 87)
            .addBox(-1.2F, 6.0F, -4.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(76, 116)
            .addBox(-0.6F, 2.1F, -4.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(108, 97)
            ...
            .texOffs(114, 78)
            .addBox(1.0F, -1.0F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(117, 81)
      ...
      PartDefinition cube_r1 = LeftArm.addOrReplaceChild(
         "cube_r1",
         CubeListBuilder.create().texOffs(62, 97).addBox(-1.0F, 1.0F, 1.0F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.6F, -2.1F, 0.0F, -0.7854F, 0.0F, 0.0F)
      );

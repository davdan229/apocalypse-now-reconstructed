...
public class Modelhazmatred<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("apocalypsenow", "modelhazmatred"), "main");
   ...
   public Modelhazmatred(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(36, 16)
            .addBox(-4.0F, -2.0F, -4.6F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(40, 61)
            .addBox(-4.0F, -8.0F, -4.6F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(9, 59)
            .addBox(-3.0F, -7.0F, -4.2F, 6.0F, 5.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(45, 46)
            .addBox(-1.0F, -3.0F, -5.6F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(60, 45)
            .addBox(3.0F, -7.0F, -4.6F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(60, 58)
            .addBox(-4.0F, -7.0F, -4.6F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
      ...
      PartDefinition Head_r3 = Head.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(38, 45)
            .addBox(-3.3F, -12.2F, -0.3F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(38, 45)
      ...
      PartDefinition Body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(44, 20)
            .addBox(-3.7F, 0.0F, -2.2F, 1.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(40, 20)
      ...
      PartDefinition RightArm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .addBox(-3.1F, 6.0F, -2.1F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(6, 0)
            .addBox(0.2F, -0.8F, -2.2F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-3.2F, -0.8F, -2.2F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(28, 32)
            .addBox(-3.1F, -0.8F, -2.1F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 11)
            .addBox(-3.2F, -0.8F, -2.2F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(20, 15)
            .addBox(-3.2F, -0.8F, 1.2F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 2)
            .addBox(-3.1F, -0.8F, -1.9F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(14, 42)
            .addBox(-3.2F, -0.8F, 2.2F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(14, 40)
            .addBox(0.2F, -0.8F, 2.2F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            ...
            .addBox(-3.1F, -0.8F, 2.1F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(1.1F, -0.8F, -1.9F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(0, 11)
            .addBox(1.2F, -0.8F, -2.2F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(6, 11)
            .addBox(1.2F, -0.8F, 1.2F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition LeftArm = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(40, 11)
            .addBox(-1.0F, -0.8F, 2.1F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 39)
            .addBox(3.3F, -0.8F, 1.2F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(2, 42)
            .addBox(2.3F, -0.8F, 2.2F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 6)
            .addBox(3.1F, -0.8F, -1.9F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(12, 42)
            .addBox(2.3F, -0.8F, -2.2F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(12, 39)
            .addBox(3.3F, -0.8F, -2.2F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(40, 13)
            .addBox(-1.0F, -0.8F, -2.1F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(0, 4)
            .addBox(-1.0F, -0.8F, -1.9F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(0, 42)
            .addBox(-1.1F, -0.8F, -2.2F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
            .texOffs(26, 15)
            .addBox(-1.1F, -0.8F, -2.2F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(2, 39)
            .addBox(-1.1F, -0.8F, 1.2F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(44, 32)
            .addBox(-1.1F, -0.8F, 2.2F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
         PartPose.offset(5.0F, 2.0F, 0.0F)
      );

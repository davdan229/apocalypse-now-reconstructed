...
public class SunglassesRenderer implements ICurioRenderer {
   private static final ResourceLocation TEXTURE = new ResourceLocation("apocalypsenow", "textures/entities/sunglasses.png");
   private final Modelescuro model = new Modelescuro(Minecraft.getInstance().getEntityModels().bakeLayer(ApocalypsenowModLayerDefinitions.SUNGLASSES));

...
public class GlassesRenderer implements ICurioRenderer {
   private static final ResourceLocation TEXTURE = new ResourceLocation("apocalypsenow", "textures/entities/oculosdeleitura.png");
   private final Modelescuro model = new Modelescuro(Minecraft.getInstance().getEntityModels().bakeLayer(ApocalypsenowModLayerDefinitions.GLASSES));

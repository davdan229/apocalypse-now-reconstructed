...
public class BandolierRenderer implements ICurioRenderer {
   private static final ResourceLocation TEXTURE = new ResourceLocation("apocalypsenow", "textures/entities/bandolier.png");
   private final Modelbandolier model = new Modelbandolier(Minecraft.getInstance().getEntityModels().bakeLayer(ApocalypsenowModLayerDefinitions.BANDOLIER));

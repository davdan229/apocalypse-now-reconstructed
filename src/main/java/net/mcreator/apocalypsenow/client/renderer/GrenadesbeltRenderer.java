...
public class GrenadesbeltRenderer implements ICurioRenderer {
   private static final ResourceLocation TEXTURE = new ResourceLocation("apocalypsenow", "textures/entities/granadebelt.png");
   private final Modelgrandebelt model = new Modelgrandebelt(
      Minecraft.getInstance().getEntityModels().bakeLayer(ApocalypsenowModLayerDefinitions.GRENADES_BELT)
   );

...
public class ShotgunbeltRenderer implements ICurioRenderer {
   private static final ResourceLocation TEXTURE = new ResourceLocation("apocalypsenow", "textures/entities/bulletbelt.png");
   private final Modelbulletbelt model = new Modelbulletbelt(Minecraft.getInstance().getEntityModels().bakeLayer(ApocalypsenowModLayerDefinitions.SHOTGUN_BELT));
